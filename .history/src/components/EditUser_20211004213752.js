...
const validationSchema = Yup.object({
  name: Yup.string().min(2, "Too Short!")
    .max(50, "Too Long!").required("Name is required"),
  email: Yup.string()
...
console.log("USERRRR",user);
  ...
  const onSubmit = (values) => {
    ...
    else if (window.confirm("Are you sure you want to save the changes ? ")) {
  ...
  return (
    ...
    >
      <Formik
        initialValues={id!=="add" ? user : initialValues}
      ...
      >
        <Form>
          ...
          <Field style={{  width: "100%" ,height:"35px" ,border:"1px solid #d9d9d9" ,borderRadius:"5px"}} type="number" name="age" id="age" />          <ErrorMessage name="age">
            {(errorMsg) => <div className="error">{errorMsg}</div>}
          </ErrorMessage>
